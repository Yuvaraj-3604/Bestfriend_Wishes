...
function MessageCard({ isActive }) {
  ...
  const message = `Dear Chandrika,

On your special day, I just want you to know how grateful I am to have you in my life. You bring so much positivity, laughter, and warmth wherever you go, and being around you always makes things brighter.

You have a heart, and you inspire the people around you more than you realize.

May this birthday mark the beginning of another amazing year filled with good health, happiness, success, and dreams coming true. You truly deserve all the love and joy the world has to offer.
